require
		.config({
			...
			paths : {
				...
				"angular-base64-upload":"../lib/angular/angular-base64-upload",

/*				"jquery": ['//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min','lib/jquery-1.10.2.min'],
				"angular": ['//ajax.googleapis.com/ajax/libs/angularjs/1.3.10/angular.min','lib/angular/angular_1.3.10.min'],
				 "angularRoute": ['//ajax.googleapis.com/ajax/libs/angularjs/1.3.10/angular-route.min', 'lib/angular-route/angular-route_1.3.10.min'],
				 "angularCookies": ['//ajax.googleapis.com/ajax/libs/angularjs/1.2.3/angular-cookies.min','lib/angular-cookies/angular-cookies_1.2.3.min'],*/
			...
			deps : [ "init", "angularCookies","angular-base64-upload", "jquery", "bootstrap", "pace",
					"scripts", "nanoscroller", "bootstrap-datepicker",
					"bootstrap-timepicker", "bootstrap-wizard",
					"daterange-picker", "fullcalendar", "select2",
					"jqueryMaskedInput", "notification", "classie",
					"modernizrCustom", "modalEffects" ]
